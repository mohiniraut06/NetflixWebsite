...
const Movie = () => {
    ...
    function fetchTrailer(id){
        fetch(`https://api.themoviedb.org/3/movie/${id}/videos?api_key=948eb6689139c6251c6e38125f8a155a`)
        .then(res=>res.json())
        .then(d=>setTrailer(d.results[0].key))
    }
    function fetchCast(id){
        fetch(`https://api.themoviedb.org/3/movie/${id}/credits?api_key=948eb6689139c6251c6e38125f8a155a`)
        .then(res=>res.json())
